...
Report bugs at https://{{cookiecutter.source_path}}/{{ cookiecutter.app_name }}/issues.
...
The best way to send feedback is to file an issue at https://{{cookiecutter.source_path}}/{{ cookiecutter.app_name }}/issues.
